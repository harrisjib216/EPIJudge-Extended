...
object PivotList {
    fun listPivoting(l: ListNode<Integer>?, x: Int): ListNode<Integer>? {
        val lessHead: ListNode<Integer> = ListNode(0, null)
        val equalHead: ListNode<Integer> = ListNode(0, null)
        val greaterHead: ListNode<Integer> = ListNode(0, null)
        var lessIter: ListNode<Integer> = lessHead
        var equalIter: ListNode<Integer> = equalHead
        var greaterIter: ListNode<Integer> = greaterHead
